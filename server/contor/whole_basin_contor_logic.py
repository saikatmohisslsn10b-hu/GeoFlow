...
def generate_whole_basin_contour_map(cn_raster_path, output_png, title):
    # 1. PREPARE & REPROJECT RASTER
    ...
    # 2. HEAVY SMOOTHING FOR CONTOURS
    ...
    # 3. BASEMAP (STEALTH OPENSTREETMAP)
    zoom = 9
    ...
    final_title = str(title).strip() if title else "Guadalupe River Basin Contour Map"
